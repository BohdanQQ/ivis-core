...
// do not use! this is exposed "internally" to avoid a circular dependency
async function init() {
    log.info(LOG_ID, 'Spawning job handler process');
    // initIndicies and cleanRuns call were once here...
    // they were moved into task-handler-init-helpers
